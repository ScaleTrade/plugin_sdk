...
struct PluginGroupRecordMargin {
    std::string symbol;
    int swap_enable = 0;
...
struct PluginGroupRecord {
    ...
    int maxsecurities = 0;
    std::unordered_map<int, PluginGroupRecordSec> secgroups;
    std::unordered_map<std::string, PluginGroupRecordMargin> secmargins;
